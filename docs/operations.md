...
```text
/opt/isarmg/sentinel-monitor/releases/0.2.12/
├─ RELEASE-MANIFEST
...
/opt/isarmg/sentinel-monitor/releases/0.2.12/native/sentinelctl bootstrap
sudoedit /etc/isarmg/sentinel-monitor.env
/opt/isarmg/sentinel-monitor/releases/0.2.12/native/sentinelctl bootstrap --confirm-config
/opt/isarmg/sentinel-monitor/releases/0.2.12/native/sentinelctl start
/opt/isarmg/sentinel-monitor/releases/0.2.12/native/sentinelctl status
```
...
```bash
/opt/isarmg/sentinel-monitor/releases/0.2.12/native/sentinelctl stop
```
...
"/opt/isarmg/sentinel-monitor/releases/0.2.12/bin/sentinel-monitor" doctor --offline
/opt/isarmg/sentinel-monitor/releases/0.2.12/native/sentinelctl start
"/opt/isarmg/sentinel-monitor/releases/0.2.12/bin/sentinel-monitor" doctor
```
