...
```text
/opt/isarmg/sentinel-monitor/releases/0.2.6/
├─ RELEASE-MANIFEST
...
/opt/isarmg/sentinel-monitor/releases/0.2.6/native/bootstrap.sh
sudoedit /etc/isarmg/sentinel-monitor.env
/opt/isarmg/sentinel-monitor/releases/0.2.6/native/bootstrap.sh --confirm-config
/opt/isarmg/sentinel-monitor/releases/0.2.6/native/start.sh
/opt/isarmg/sentinel-monitor/releases/0.2.6/native/status.sh
```
...
```bash
/opt/isarmg/sentinel-monitor/releases/0.2.6/native/stop.sh
```
...
"/opt/isarmg/sentinel-monitor/releases/0.2.6/bin/sentinel-monitor" doctor --offline
/opt/isarmg/sentinel-monitor/releases/0.2.6/native/start.sh
"/opt/isarmg/sentinel-monitor/releases/0.2.6/bin/sentinel-monitor" doctor
```
