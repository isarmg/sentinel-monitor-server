...
```text
/opt/isarmg/sentinel-monitor/releases/0.2.9/
├─ RELEASE-MANIFEST
...
/opt/isarmg/sentinel-monitor/releases/0.2.9/native/sentinelctl bootstrap
sudoedit /etc/isarmg/sentinel-monitor.env
/opt/isarmg/sentinel-monitor/releases/0.2.9/native/sentinelctl bootstrap --confirm-config
/opt/isarmg/sentinel-monitor/releases/0.2.9/native/sentinelctl start
/opt/isarmg/sentinel-monitor/releases/0.2.9/native/sentinelctl status
```
...
```bash
/opt/isarmg/sentinel-monitor/releases/0.2.9/native/sentinelctl stop
```
...
"/opt/isarmg/sentinel-monitor/releases/0.2.9/bin/sentinel-monitor" doctor --offline
/opt/isarmg/sentinel-monitor/releases/0.2.9/native/sentinelctl start
"/opt/isarmg/sentinel-monitor/releases/0.2.9/bin/sentinel-monitor" doctor
```
